...
class SquareMoverNode(Node):
    def __init__(self):
        ...
        # ====== PENGATURAN LINTASAN (ubah di sini sesuai kebutuhan) ======
        self.panjang = 3.0     # meter, sisi panjang
        self.lebar = 1.5       # meter, sisi pendek
 
        self.kecepatan_linear = 0.5    # m/s
        self.kecepatan_angular = 0.5   # rad/s
        # ===================================================================
 
        # Waktu maju dihitung dari jarak / kecepatan
        self.waktu_panjang = self.panjang / self.kecepatan_linear
        self.waktu_lebar = self.lebar / self.kecepatan_linear
 
        # Waktu belok 90 derajat = (pi/2) / kecepatan_angular
        # angular.z NEGATIF = belok KANAN (searah jarum jam)
        self.waktu_belok = (math.pi / 2) / self.kecepatan_angular
 
        # Urutan gerak: (durasi, linear, angular, label_log)
        self.sequence = [
        ...
        # Hitung batas waktu kumulatif tiap akhir fase
        self.batas_waktu = []
        total = 0.0
